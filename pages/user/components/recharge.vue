<template>
	<el-dialog class="dialog" title="test" :close-on-click-modal="false" :visible.sync="formVisible">
	    <el-form ref="dataForm" :rules="rules" :model="formData" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
			<el-form-item label="充值金额" prop="logistic_code">
	            <el-input v-model="formData.money" clearable maxlength="50" placeholder="test" />
	        </el-form-item>
	    </el-form>
	...
	export default {
		data() {
			return {
				...
				formData: {}, //表单数据
				rules: {
					money: [{required: true, message: 'test', trigger: 'blur'}],
				}
			}
		},
		methods: {
