    ...
    <div>
            ...
            <div class="spec-item" v-for="(specItem, specIndex) in specList" :key="specIndex">
                ...
                <div class="attr-list">
                    ...
                    <div class="attr-input-wrapper">
                        <el-input maxlength="50" placeholder="请输入规格值" v-model="specItem.newAttr"></el-input>
        ...
        <div v-if="newState" class="spec-add-wrapper">
            <div class="spec-add-input-wrapper">
                <el-input v-model="newSpec" maxlength="50" placeholder="请输入规格名称"></el-input>
                <el-input v-model="newAttr" maxlength="50" placeholder="请输入规格值"></el-input>
            </div>
